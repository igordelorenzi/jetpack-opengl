...
/**
 * Multiple JWavefront object viewer.
 *
 * @author Fernando V. Paulovich
 */
public class TestMultipleModelViewer extends GLJPanelInteractive {

    public TestMultipleModelViewer(GLCapabilities glcaps, ArrayList<JWavefrontModel> models) {
        super(glcaps);
        this.models = models;
    }
    ...
    public void display(GLAutoDrawable glad) {
        ...
        for (int i = 0; i < models.size(); i++) {
            float trans = 2 * (i - (models.size() / 2));
            gl.glTranslatef(trans, 0, 0);
            models.get(i).draw(glad);
            gl.glTranslatef(-trans, 0, 0);
        }
    ...
    public static void main(String args[]) throws IOException {
        ...
        ArrayList<JWavefrontModel> models = new ArrayList<JWavefrontModel>();
        models.add(new JWavefrontModel(new File("./data/chapel/chapel.obj")));
        ...
        TestMultipleModelViewer viewer = new TestMultipleModelViewer(glcaps, models);
